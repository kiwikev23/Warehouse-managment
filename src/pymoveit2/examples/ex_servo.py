...
class ServoNode(Node):
    ...
    def servo(self, end_point,i):
        ...
        while True:
            ...
            if i==0:
                ...
                if np.abs(err_x)<0.03 and np.abs(err_y)<0.41 and np.abs(err_z)<0.14:
                    # print("i did it fr")
                    self.publisher.publish(twist_msg)
                    break
    ...
    def servo1(self, end_point,initial_point,i):
        # Define your movement sequence for NodeB here
        twist_msg = TwistStamped()
        prev_x = 0
        prev_y = 0
        ...
        while True:
            ...
            xu = end_point[0] - initial_point[0]
            yu = end_point[1] - initial_point[1]
            zu = end_point[2] - initial_point[2]

            mag = (xu**2+yu**2+zu**2)**0.5
            ...
            err_mag = (err_x**2 + err_y**2 + err_z**2)**0.5
...
1.5717372229128688]
    ...
    def moving(dict):
        ...
        if dict.get('position') == 'center_left':
            ...
            servo_node.servo1(dict.get('coordinates'),mid_point,0)
            # time.sleep(1)
            ...
            print("left coordinates: ",dict.get('coordinates'))
            ...
            joint_node.joint_position(joint_positions_right)
            print("right coordinates: ",dict.get('coordinates'))
